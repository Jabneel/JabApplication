...
public class MainActivity extends Activity  {
    ...
    private void loadSavedPreferences(){
            ...
            String name = sharedPreferences.getString("Name_Value", "empty");
            int value = sharedPreferences.getInt("Num_Value", 0);
        ...
        if(checkBoxValue){
            flag = "Checked!";
                ...
                nameRet.setText(name);
                cbValue.setText(flag);
                numRet.setText(String.valueOf(value));
